...
const Detail = () => {
  const [data, setData] = useState<Data>({} as Data);
    ...
    function handleWhatsApp() {
        Linking.openURL(`whatsapp://send?phone=${data.location.whatsapp}`);
    }

    function handleComposeMail() {
      MailComposer.composeAsync({
        subject: 'Coleta de resíduos recicláveis',
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage} source={{ uri: data.location.image }} /> 
